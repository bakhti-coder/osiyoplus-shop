          ...
          <div className="grid mx-5 xl:mx-0 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {React.Children.toArray(
              [
                ...
                <div className="p-5 bg-white border border-light cursor-pointer rounded-lg h-full">
        ...
        <div className="container py-20 max-w-1200">
          <div className="flex justify-around items-center flex-wrap md:flex-nowrap ">
            <div className="text-center mt-10 md:mt-0">
              <Image
                src="/source/image/svg/Services.svg"
                height={80}
                width={80}
                alt="alo"
                className="mx-auto"
              />
              <h1 className="mt-6 text-black font-[600] text-[20px]">{`TEZ YETKAZIB BERISH`}</h1>
              <p className="text-[14px]">{`O'zbekiston bo'ylab tez yetkazib berish`}</p>
            </div>
            <div className="text-center mt-10 md:mt-0">
              <Image
